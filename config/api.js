...
const ApiRootUrl = 'https://www.oldcow.shop/api/';
...
module.exports = {
    ...
    //新增
    //      工厂
    BrandList: ApiRootUrl + 'brand/list', //绿色工厂列表
    BrandDetail: ApiRootUrl + 'brand/detail', //绿色工厂详情
  FactoryBlogList: ApiRootUrl + 'brand/blogList',//绿色工厂文章
    //      小镇
  TownList: ApiRootUrl + 'towninfo/list', //城镇列表
  TownDetail: ApiRootUrl + 'towninfo/detail', //乡镇详情详情
  TownBlogList: ApiRootUrl + 'towninfo/blogList',//
  VillageList: ApiRootUrl + 'villageinfo/list', //村庄列表
  VillageDetail: ApiRootUrl + 'villageinfo/detail', //村庄详情
  VillageBlogList: ApiRootUrl + 'villageinfo/blogList',
  //文章
  BlogDetail: ApiRootUrl + 'blog/detail',
  //上新、热卖、专享
  NewGoodsList: ApiRootUrl + 'newgoods/index', // 本周上新接口
  HotGoodsList: ApiRootUrl + 'hotgoods/index', // 爆款产品接口
  //三大分类
  CountryGoodsList: ApiRootUrl + 'countrygoods/index', //乡村旅游接口
  StudyGoodsList: ApiRootUrl + 'studygoods/index', //研学教培接口
  HouseGoodsList: ApiRootUrl + 'housegoods/index',//民宿客栈接口
